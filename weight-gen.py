...
def generatePic(weight):
    ...
    d.text(((W-w)/2,380), weight_str, font=fnt, fill=(255,255,255))
    
    img.save('D:/weight_pic.png')

def setWallpaper():
    ctypes.windll.user32.SystemParametersInfoW(20, 0, 'D:/weight_pic.png', 0)  # set wallpaper
